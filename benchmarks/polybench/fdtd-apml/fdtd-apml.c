		      ...
		      DATA_TYPE POLYBENCH_1D(cyph,CYM+1,cym+1))
{
  ...
  #pragma acc data \
    create(clf[0:CYM+1][0:CXM+1],tmp[0:CYM+1][0:CXM+1])	\
    copyin(Ax[0:CZ+1][0:CYM+1],Ry[0:CZ+1][0:CYM+1], \
            Ex[0:CZ+1][0:CYM+1][0:CXM+1], \
            Ey[0:CZ+1][0:CYM+1][0:CXM+1],Hz[0:CZ+1][0:CYM+1][0:CXM+1], \
            czm[0:CZ+1],czp[0:CZ+1],cxmh[0:CXM+1],cxph[0:CXM+1],cymh[0:CYM+1], \
            cyph[0:CYM+1]) \
    copyout(Bza[0:CZ+1][0:CYM+1][0:CXM+1],Ex[0:CZ+1][0:CYM+1][0:CXM+1], \
            Ey[0:CZ+1][0:CYM+1][0:CXM+1],Hz[0:CZ+1][0:CYM+1][0:CXM+1])
  {
    #pragma acc parallel
    {
