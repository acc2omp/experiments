		       ...
		       DATA_TYPE POLYBENCH_3D(sum_diff,MAXGRID,MAXGRID,LENGTH,maxgrid,maxgrid,length))
{
  ...
  #pragma scop
  #pragma acc data copy(path[0:MAXGRID][0:MAXGRID]) \
    copyin(sum_tang[0:MAXGRID][0:MAXGRID],mean[0:MAXGRID][0:MAXGRID]) \
    create(diff[0:MAXGRID][0:MAXGRID][0:LENGTH],sum_diff[0:MAXGRID][0:MAXGRID][0:LENGTH])
  {
    #pragma acc parallel
    {
