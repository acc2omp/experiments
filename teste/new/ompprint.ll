; ModuleID = '/home/felipe.emos/teste/new/ompprint.cpp'
source_filename = "/home/felipe.emos/teste/new/ompprint.cpp"
...
entry:
  ...
  call void @__kmpc_for_static_init_4(%ident_t* @0, i32 %2, i32 34, i32* %.omp.is_last, i32* %.omp.lb, i32* %.omp.ub, i32* %.omp.stride, i32 1, i32 1)
...
omp.body.continue:                                ; preds = %invoke.cont3
